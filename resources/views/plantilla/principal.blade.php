  ...
  <div id="app">
    <header class="app-header navbar">
      ...
      <a class="navbar-brand" href="/main">
        <img class="navbar-brand-full" src="img/logomoto-sinfondo.png" width="40" height="55" alt="LogoSPT">
       <!-- <img class="navbar-brand-minimized" src="img/logomoto-sinfondo.png" width="40" height="55" alt="LogoSPT">-->
      </a>
      ...
      <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true" style="cursor:pointer">
            <img class="navbar-brand-full" src="img/logomoto-sinfondo.png" width="40" height="55" alt="sam">
